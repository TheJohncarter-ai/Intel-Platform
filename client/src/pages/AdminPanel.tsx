...
export default function AdminPanel({ onLogout }: AdminPanelProps) {
  const [activeTab, setActiveTab] = useState<"requests" | "whitelist">(
    "requests"
  );
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left px-4 py-3 font-mono-label text-[0.6rem] text-muted-foreground">
                        EMAIL
                      </th>
                      <th className="text-left px-4 py-3 font-mono-label text-[0.6rem] text-muted-foreground">
                        NAME
                      ...
                      <th className="text-right px-4 py-3 font-mono-label text-[0.6rem] text-muted-foreground">
                        ACTIONS
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right">
                          {entry.email !== "powelljohn9521@gmail.com" ? (
                            ...
                            <span className="text-[0.6rem] text-muted-foreground/40 font-mono-label">
                              PROTECTED
                            </span>
                          )}
                        </td>
